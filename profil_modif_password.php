...
<body>
    ...
    <main class="bg-dark d-flex align-items-center" id="profil_modif_password">
        <div class="container">
            <div class="row justify-content-center grid gap-5 flex-nowrap rounded border border-secondary p-5" id="row_profil_modif_password">

                <!-- Formulaire connexion -->
                <div class="col-md-6 bg-transparent text-white rounded border border-secondary" id="col_profil_modif_password">
